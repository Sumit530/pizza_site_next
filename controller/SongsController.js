...
exports.get_song_to_video = async(req,res) =>{
    ...
    return res.status(201).json({status:1,message:"data found",data:{song_id:single_song_data[0]._id,song_name:single_song_data[0].name,song_banner_image:song_banner_image,song_url:attachment,total_videos:total_videos,singer_id:single_song_data[0]?.singer_id?._id,singer_description:single_song_data[0]?.singer_id.description,is_song_bookmark:is_song_bookmark, video_data:songData,status:1,message:"data found"}})
